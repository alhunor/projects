...
void MD5Final (MD5_CTX *mdContext)
{
  ...
  MD5Update (mdContext, (char*)PADDING, padLen);
...
// Computes the message digest for string inString. Prints out message digest, a space, the string (in quotes) and a carriage return.
...
// Computes and returns the message digest for a specified file. return true if MD5 has been computed succesfully
 bool MDFile (const char * filename, MD5_CTX* mdContext)
{
